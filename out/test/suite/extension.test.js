...
suite('API Vault Extension Test Suite', () => {
    ...
    let mockGlobalState;
    setup(() => {
        mockSecrets = new testUtils_1.MockSecretStorage();
        mockGlobalState = new testUtils_1.MockMemento();
        storage = new storage_1.VSCodeStorageManager(mockSecrets, mockGlobalState);
    });
